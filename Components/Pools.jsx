...
import { FaRegCopy, MdOutlineAttachMoney } from "./ReactICON/index";
          ...
          <div className="col-12 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
            <div className="section__title">
              ...
              <p>
                ...
                cumque provident. Molestias mollitia sequi cum error numquam,
                velit nihil suscipit perspiciatis inventore quae necessitatibus
                ratione explicabo eaque quia voluptatem ullam.
              </p>
            </div>
          </div>
        </div>
              ...
              >
                <div className="apool">
                  ...
                  <div className="apool__group">
                    {" "}
                    <label className="apool__label" htmlFor="pool1">
