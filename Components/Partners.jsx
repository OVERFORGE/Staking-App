...
const Partners = () => {
  const partners = [
    {
      name: "theexecutioners.in",
      image: "img/partners/logo1.svg",
      url: "https://theexecutioners.in",
    },
    {
      name: "theexecutioners.in",
          ...
          <div className="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-8 offset-xl-2">
            <div className="section__title">
              ...
              <p>
                ...
                Sapiente, similique placeat ipsam nulla deserunt explicabo amet
                nobis! Totam ex, animi illum, cumque nam architecto impedit
                consequatur mollitia odio, voluptates unde?
              </p>
            </div>
          </div>
        </div>
