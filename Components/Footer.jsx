        ...
        <div className="row">
          <div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-1 order-lg-4 order-xl-1">
            ...
            <p className="footer__tagline">
              ...
              beatae aliquam soluta neque perferendis natus quae!
            </p>
          </div>
          ...
          <div className="col-6 col-md-8 col-lg-6 col-xl-4 order-2 order-md-3 order-lg-1 order-xl-2">
            <div className="row">
          ...
          <div className="col-12">
            <div className="footer__content">
              ...
              <small className="footer__copyright">
                @ Stoken, 2025, Created by{" "}
                <a href="www.github.com/OVERFORGE" target="_blank">
                  @OVERFORGE
                </a>
              </small>
            </div>
