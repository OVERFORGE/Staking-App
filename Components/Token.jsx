            ...
            <div className="invest invest--big">
              <h2 className="invest__title">
                <div className="row">
                  ...
                  <div className="col-12 col-lg-5 offset-lg-1">
                    <div className="invest__rate-wrap">
                      <div className="invest__rate">
                        <span>Total Stake</span>
                        <p className="green">1 ExE = 0.00001 ETH</p>
                      </div>
                      <div className="invest__graph">
                ...
                <p className="invest__info">
                  ...
                  obcaecati magnam quis dolorem illo itaque, nobis quas ullam
                  adipisci dolor debitis labore facere veniam possimus optio
                  cumque perspiciatis. Expedita, harum.
                </p>
              </h2>
            </div>
          </div>
